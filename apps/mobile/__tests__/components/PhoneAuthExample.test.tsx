...
describe('PhoneAuthExample', () => {
  ...
  it('renders phone input screen when user is not signed in', () => {
  ...
  it('switches to verification code screen after sending code', async () => {
    ...
    const { getByText, getByPlaceholderText, findByText, findByPlaceholderText } = render(<PhoneAuthExample />);
  ...
  describe('Verification code step', () => {
    ...
    it('shows error when verification code is empty', async () => {
      const { getByText, getByPlaceholderText, findByText } = render(<PhoneAuthExample />);
    ...
    it('calls verifyPhoneCode with correct arguments', async () => {
      ...
      const { getByText, getByPlaceholderText, findByPlaceholderText } = render(<PhoneAuthExample />);
