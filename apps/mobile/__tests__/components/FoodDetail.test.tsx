...
describe('FoodDetail', () => {
  ...
  it('formats added time when provided', () => {
    ...
    // The time format depends on locale, but should contain hour and minute
    // Format is like "2:30 PM" for en-US
  ...
  it('handles food with no serving unit', () => {
    ...
    // There may be multiple '1' values (serving size, quantity, etc.)
