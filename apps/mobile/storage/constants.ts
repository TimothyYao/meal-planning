/**
 * Storage key constants for AsyncStorage
 */
export const DAILY_LOGS_KEY = '@meal_planning:daily_logs';
export const FOODS_KEY = '@meal_planning:foods';
...
export const LAST_DATE_KEY = '@meal_planning:last_date';
